...
const Navbar: React.FC<NavbarProps> = ({ className }) => {
  return (
    <header className={cn("w-full py-4 px-6 md:px-8 fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between", className)}>
